#!/usr/bin/env bash
echo "Configuracion sesiones de HAProxy"
...
sudo cp ~/balanceadores-java-haproxy/configuracion-haproxy/ubuntu/haproxy.cfg.sesiones /etc/haproxy/haproxy.cfg
...
echo "Completando ambiente Sesiones"